...
import { Camera, Color } from "@/lib/liveblock/types";
import { useMutation, useSelf } from "@/liveblocks.config";
import useDeleteLayers from "@/hooks/liveblock/useDeleteLayers";
import useSelectionBounds from "@/hooks/liveblock/useSelectionBounds";
...
function SelectionTools({
  ...
  return (
    <div
      className="px-2 py-0.5 absolute shadow-lg rounded-lg border flex items-center justify-center"
      style={{
